                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('attendancegroup.update', [$attendancegroup]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="group_difficulty" value="{{$attendancegroup->difficulty}}" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="group_schoolid" value="{{$attendancegroup->school_id}}" required autofocus>
                            </div>
                        </div>
